...
tile_orth_share = 7.4 # RNAduplex<=8.0 implies binding<=12 
...
# If this is defined, it defines mutually exclusive pairs of tiles (their names, actually) that will never be together in the same pot 
